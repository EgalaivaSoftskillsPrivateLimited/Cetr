    ...
    <div className="flex gap-1.5" role="radiogroup" aria-label="Overall workshop rating">
      {[1, 2, 3, 4, 5].map((n) => (
        <button
          ...
          onClick={() => onChange(n)}
          className="flex h-12 max-w-[52px] flex-1 items-center justify-center text-4xl leading-none transition-transform active:scale-90"
        >
...
function Sidebar({ programName }: { programName: string }) {
  return (
    <aside className="flex flex-col gap-5 bg-navy-soft p-6 text-cream sm:p-8 md:p-10">
      ...
      <p className="text-sm leading-relaxed text-cream/70">
        ...
        feedback to receive your {programName} certificate.
      </p>
      ...
      <p className="text-xs text-cream/45">
        ...
        <Link href="/verify" className="font-semibold text-lime underline-offset-2 hover:underline">
          Verify it here
        </Link>
      </p>
...
export default function ClaimFlow({
  ...
  const [issuedProgramName, setIssuedProgramName] = useState<string>(programName);
  const [issuedCertificateType, setIssuedCertificateType] = useState<string>("Appreciation");
  ...
  const handleFeedbackSubmit = async () => {
    ...
    try {
      ...
      setIssuedProgramName(body.programName ?? programName);
      setIssuedCertificateType(body.certificateType ?? "Appreciation");
  ...
  if (step === 4 && submission && certificateId) {
    return (
      <>
        <div className="flex min-h-screen items-center justify-center overflow-x-hidden bg-paper-soft px-5 py-10">
          <div className="relative mx-auto flex w-full max-w-[420px] animate-confirm-in flex-col items-center gap-3.5 rounded-[28px] border-[1.5px] border-dashed border-ink/15 bg-paper p-9 text-center shadow-[0_40px_80px_rgba(0,0,0,0.35)]">
            ...
            <p className="text-sm leading-relaxed text-ink/60">
              Thank you for completing the {issuedProgramName}, knowledge check, and feedback.
            </p>
    ...
    <div className="flex min-h-screen items-center justify-center bg-paper-soft px-5 py-10">
      <div className="relative w-full max-w-[920px]">
        ...
        <div className="grid grid-cols-1 overflow-hidden rounded-[28px] shadow-[0_40px_80px_rgba(0,0,0,0.35)] md:grid-cols-[minmax(260px,340px)_1fr]">
          ...
          <div className="flex flex-col gap-6 bg-paper p-6 sm:p-8 md:p-10">
              ...
              <div className="step-enter flex flex-col gap-6" key="step-1">
                <div>
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-ink/60">
                    Enter your details to verify your {programName} participation and prepare
                    your certificate.
                  </p>
                </div>
            ...
            {step === 2 && quizPhase === "question" && (
              <div className="step-enter flex flex-col gap-6" key={`step-2-q-${questionIndex}`}>
                <div>
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-ink/60">
                    Answer these 4 questions based on what you learned during the {programName}.
                  </p>
                </div>
