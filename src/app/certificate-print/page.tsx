...
import { CertificateQRCode, buildVerificationUrl } from '@/utils/qrcode';
...
export default function Certificate({
  recipientName = 'Toumik Haque',
  programName = 'React Development Internship',
  duration = '2 months',
  companyName = 'Egalaiva technologies',
  issueDate = '23 Sept, 2025',
  founderName = 'Aadhithya S',
  founderTitle = 'Director- Egalaiva Softskills Pvt. Ltd.',
